...
export function* asyncPlaySpiceMerchantTrash() {
...
const spiceMerchantSagas = [
  ...
  takeEvery("ASYNC_PLAY_SPICE_MERCHANT_ADD_BUY_AND_GOLD", asyncPlaySpiceMerchantAddBuyAndGold),
  takeEvery("ASYNC_PLAY_SPICE_MERCHANT_DRAW_CARDS_AND_ACTION", asyncPlaySpiceMerchantDrawCardsAndAction)
];
